...
| 4| Repartición desequilibrada de tareas | 1,25 | 3 | Asignar más personas para esa tarea. Seccionar esa tarea en varias tareas más pequeñas. Cambiar tareas de un miembro a otro en caso de que la diferencia de carga de tareas sea grande. Asignar a un ayudante en alguna tarea para la persona que tenga más issues.
...
| 20| Problemas de coordinación entre subgrupos o miembros | 1,20 | 3 | Mejorar la comunicación entre miembros. Organización por parte de los coordinadores.
